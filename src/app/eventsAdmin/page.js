        ...
        <ProtectedRoute requireAdmin={true}>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 p-4 md:p-8">
                <div className="max-w-7xl mx-auto">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div>
                                ...
                                <p className="text-gray-300">
                                    Administra eventos especiales y sus participantes
                                </p>
                            </div>
                            ...
                            {events.map((ev, index) => (
                                <div key={ev.id} className="bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg overflow-hidden hover:bg-white/15 transition-all duration-300 shadow-lg hover:shadow-xl">
                                    ...
                                    <div className="relative h-40 bg-gradient-to-br from-gray-800 to-gray-900">
                                        ...
                                        <div className="absolute top-2 left-2 bg-orange-600 text-white px-2 py-1 rounded-full text-sm font-bold">#{ev.id}</div>
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div>
                                            <label className="block text-gray-300 font-semibold mb-2 text-sm">Título</label>
                                        ...
                                        <div>
                                            <label className="block text-gray-300 font-semibold mb-2 text-sm">Descripción</label>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <label className="block text-gray-300 font-semibold mb-2 text-sm">Fecha</label>
                                            ...
                                            <div>
                                                <label className="block text-gray-300 font-semibold mb-2 text-sm">Hora</label>
                                        ...
                                        <div>
                                            <label className="block text-gray-300 font-semibold mb-2 text-sm">Pista</label>
                                        ...
                                        <div>
                                            <label className="block text-gray-300 font-semibold mb-2 text-sm">Banner (URL o archivo)</label>
                                        ...
                                        <div className="pt-4 border-t border-white/20">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="text-gray-300 font-semibold">Participantes ({ev.participants?.length || 0}/{ev.maxParticipants || 16})</div>
                                        ...
                                        <div>
                                            <label className="block text-gray-300 font-semibold mb-2 text-sm">Máximo de participantes</label>
                    ...
                    {events.length > 0 && (
                        <div className="mt-8 bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg p-6">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                                <div className="text-white">
                                    <p className="font-semibold">Total de eventos: {events.length}</p>
                                    <p className="text-sm text-gray-300">Recuerda guardar los cambios antes de salir</p>
                                </div>
                                <button
                                    onClick={handleSave}
                                    className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2"
                                >
