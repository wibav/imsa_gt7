...
export default function DashboardRenovated() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
            ...
            {/* <div className="bg-gradient-to-r from-green-700/30 to-emerald-700/30 border-b border-green-500/20">
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3 min-w-0">
                        <span className="text-xl sm:text-2xl flex-shrink-0">💬</span>
                        <p className="text-green-300 text-xs sm:text-sm font-medium">
                            ¡Únete a nuestra comunidad! Recibe avisos de eventos y novedades del campeonato.
                        </p>
                    </div>
                    <a
                        ...
                        className="flex-shrink-0 bg-green-500 hover:bg-green-400 text-white text-xs sm:text-sm font-bold px-3 sm:px-4 py-2 rounded-full transition-colors whitespace-nowrap flex items-center gap-1.5"
                    >
